...
<script
	src="https://apis.openapi.sk.com/tmap/jsv2?version=1&appKey=l7xx4d9f215a56ce4d44935465a1ad9e843f"></script>
...
function initTmap(){
	...
	$("#btn_select").click(function(){
		...
		$.ajax({
			...
			async:false,
			data:{
				"appKey" : "l7xx4d9f215a56ce4d44935465a1ad9e843f",
			...
			success:function(response){
				...
				for(var k in resultpoisData){
					...
					marker = new Tmapv2.Marker({
						...
						iconSize : new Tmapv2.Size(30, 50),
						title : name,
						map:map
				 	});
