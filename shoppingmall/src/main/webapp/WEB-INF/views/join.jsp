...
<script type="text/javascript">
     ...
     function IdCheck(){
    	 //아이디 중복확인
    	 window.open("resources/IdCheck.jsp", "IDC", "width=400 height=350")
...
<div class="main">
         <div class="col-md-6 col-sm-12">
            <div class="login-form">
               <form name ="join" onsubmit="return Validation(this);" action ="join" method="post">
                  <div class="form-group">
                     <label>ID</label>
                     <input type="text" class="form-control" name ="id" id="id">
                     <button type="button" onclick="location.href='IdCheck'" class="btn btn-secondary">ID 중복체크</button>
