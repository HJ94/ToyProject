			...
			<c:forEach items="${newproduct}" var="newproduct">
				<div class="col-lg-3 col-md-6 mb-4">
					<div class="card h-100">
						<a href="product_detail?pseq=${newproduct.pseq}"> <img
							class="card-img-top" src="resources/image/${newproduct.image}"
						...
						<div class="card-footer">
							<fmt:formatNumber value="${newproduct.price}" type="currency" />
						</div>
					</div>
				</div>
			</c:forEach>
